{
  ...
  inputs = {
    ...
    koishi-theme = {
      flake = false;
      owner = "gynamics";
      repo = "koishi-theme.el";
      type = "github";
    };
    laas = {
      flake = false;
      owner = "tecosaur";
      repo = "LaTeX-auto-activating-snippets";
      type = "github";
    };
    lisp-semantic-hl = {
      flake = false;
      owner = "calsys456";
      repo = "lisp-semantic-hl.el";
      type = "github";
    };
    llama = {
      flake = false;
